...
df_inserir_cassandra = spark.read.option('encoding', 'UTF-8').parquet(r"C:\Users\elihe\Desktop\atividade_final\scripts\parquet_somente_reserva_petroleo_geral")
...
saveData(df_cassandra_comID, "panorama_geral_petr_reserva")
