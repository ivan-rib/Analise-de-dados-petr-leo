...
df_inserir_cassandra = spark.read.option('encoding', 'UTF-8').parquet(r"C:\Users\elihe\Desktop\atividade_final\scripts\parquet_distribuidoras")
df_cassandra_comID = df_inserir_cassandra.withColumn("id_distr", expr("uuid()"))
...
saveData(df_cassandra_comID, "panorama_geral_petr_distribuidora")
