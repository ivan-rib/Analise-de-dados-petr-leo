...
terra_primeiro_tri = spark.read.format("csv").option("header", "True").option("delimiter", ",").option("inferSchema", "true").option("encoding", "ISO-8859-1").load(r"./producao_petroleo_gas_nacional_producao-terra-2018-2trim.csv")
...
#gravando dados tratados no formato csv
terra.repartition(1).write.option("header", "false").option("encoding", "UTF-8").csv("producao_petroleo_gas_nacional_producao-terra-2018-2trim_tratado.csv")
